...
do
  wget --user-agent="Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:21.0) Gecko/20100101 Firefox/21.0" \
    "http://api.omim.org/api/clinicalSynopsis?mimNumber=${id}&include=clinicalSynopsis,externalLinks&format=tsv&apiKey=1F2C6A581AC1E428183A107988EB56E579DE7F02" \
  -O raw/synopses/${id}.synopsis.txt
done
