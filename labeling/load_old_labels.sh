...
./convert_old_gp_labels ../onto/manual/genepheno_holdout_labels_caus.tsv > tmp.tsv
...
./convert_old_gp_labels ../onto/manual/genepheno_holdout_labels_assoc.tsv > tmp.tsv
